"""Preprocess CrossNER formatted dataset to convert into OWNER format
"""
import os
...
class CrossNerPreprocessor(BasePreprocessor):
    """Preprocess CrossNER dataset
    """
